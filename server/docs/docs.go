    ...
    "paths": {
        ...
        "/dnsUser/createDnsUser": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建DnsUser",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.DnsUser"
                        }
                    }
                ],
                "responses": {
        ...
        "/dnsUser/getDnsUserList": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "分页获取DnsUser列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.DnsUserSearch"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.DomainListSearch"
                        }
                    }
                ],
                "responses": {
        ...
        "/domainList/updateDomains": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"success\":true,\"data\":{},\"msg\":\"批量更新成功\"}",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/recordList/getRecordList": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "分页获取record列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.RecordListSearch"
                        }
                    }
                ],
                "responses": {
