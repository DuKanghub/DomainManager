...
func (d *dictionaryDetail) Init() error {
	var details = []model.SysDictionaryDetail{
		...
		{global.GVA_MODEL{ID: 24, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "阿里云", 1, status, 1, 7},
		{global.GVA_MODEL{ID: 25, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "腾讯云", 2, status, 2, 7},
		{global.GVA_MODEL{ID: 26, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "默认", 1, status, 1, 10},
		{global.GVA_MODEL{ID: 27, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "联通", 2, status, 2, 10},
		{global.GVA_MODEL{ID: 28, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "电信", 3, status, 3, 10},
		{global.GVA_MODEL{ID: 29, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "移动", 4, status, 4, 10},
		{global.GVA_MODEL{ID: 30, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "A", 1, status, 1, 11},
		{global.GVA_MODEL{ID: 31, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "CNAME", 2, status, 2, 11},
		{global.GVA_MODEL{ID: 32, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "AAAA", 3, status, 3, 11},
		{global.GVA_MODEL{ID: 33, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "NS", 4, status, 4, 11},
		{global.GVA_MODEL{ID: 34, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "MX", 5, status, 5, 11},
