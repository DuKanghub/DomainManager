    ...
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        <el-form-item label="路径">
          <el-input v-model="searchInfo.path" placeholder="路径" @keyup.enter.native="onSubmit" />
        </el-form-item>
        <el-form-item label="描述">
          <el-input v-model="searchInfo.description" placeholder="描述" @keyup.enter.native="onSubmit" />
        </el-form-item>
        <el-form-item label="api组">
          <el-input v-model="searchInfo.apiGroup" placeholder="api组" @keyup.enter.native="onSubmit" />
        </el-form-item>
