<template>
  <div>
    ...
    >
      ...
      <el-table-column label="dns子用户名" prop="name" width="120" /> 
      <el-table-column label="平台" prop="platform" width="120">
        <template slot-scope="scope">
          {{filterDict(scope.row.platform,"CloudPlatForm")}}
        </template>
      </el-table-column>
      <el-table-column label="AccessKey" prop="accessKey" width="120" /> 
      <el-table-column label="AccessSecret" prop="accessSecret" width="120" /> 
